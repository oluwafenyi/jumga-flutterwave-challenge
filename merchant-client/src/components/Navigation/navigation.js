    ...
    return(
        <div className="alt-navigation">
            ...
            <div className={`mobile-menu-container ${altMenu ? "show-mobile-menu" : ""}`}>
                ...
                <ul className="mobile-menu">
                    <li><Link to={ clientLink + "/" } className="mobile-menu-item">
                    ...
                    <li><Link to={ clientLink + "/products" } className="mobile-menu-item">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li><Link to={ clientLink + "/stores" } className="mobile-menu-item">
                    ...
                    <li><a href="/login" className="mobile-menu-item">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0)">
