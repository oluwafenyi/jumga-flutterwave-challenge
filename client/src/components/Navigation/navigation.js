...
function Navigation() {
        ...
        if(location.pathname !== '/' ){
            return(
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M25 26.25V23.75C25 22.4239 24.4732 21.1521 23.5355 20.2145C22.5978 19.2768 21.3261 18.75 20 18.75H10C8.67392 18.75 7.40215 19.2768 6.46447 20.2145C5.52678 21.1521 5 22.4239 5 23.75V26.25" stroke="black" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M15 13.75C17.7614 13.75 20 11.5114 20 8.75C20 5.98858 17.7614 3.75 15 3.75C12.2386 3.75 10 5.98858 10 8.75C10 11.5114 12.2386 13.75 15 13.75Z" stroke="black" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            )
        }else{
            return(
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M25 26.25V23.75C25 22.4239 24.4732 21.1521 23.5355 20.2145C22.5978 19.2768 21.3261 18.75 20 18.75H10C8.67392 18.75 7.40215 19.2768 6.46447 20.2145C5.52678 21.1521 5 22.4239 5 23.75V26.25" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    return (
        <div className="navigation">
            <button className={`mobile-menu-btn ${location.pathname !== '/' ? "dark-mobile-btn" : ""}`} onClick={ ()=>setMobileMenu(true) }>
            ...
            <div className={`mobile-menu-container ${showMobileMenu ? "show-mobile-menu" : ""}`}>
                <button className="close-menu-btn" onClick={ ()=>setMobileMenu(false) }>
                ...
                <ul className="mobile-menu">
                    ...
                    <li><Link to="/products" className="mobile-menu-item">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li><Link to="/stores" className="mobile-menu-item">
                    ...
                    <li><a href={ merchantLink + "/signup" } className="mobile-menu-item">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0)">
